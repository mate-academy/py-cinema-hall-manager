...
class ActorManager:
    def __init__(self):
        self._connection = sqlite3.connect("D:/for prog/library_db/cinema.db3")
    ...
    def all(self):
        ...
        return [Actor(*line) for line in actor_cursor]

    def update(self, id_to_update: int, new_first_name: str, new_last_name):
